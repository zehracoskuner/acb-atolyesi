...
export const TOUR_STEPS = {
  ...
  karakter: [
    ...
    },
    {
      ...
      text: "➕ butonuna basarak yeni karakter ekle. İsim, rol, motivasyon — ne kadar doluysa AI o kadar derinleştirebilir.",
      position: "bottom",
      alwaysVisible: true,
    },
    {
  ...
  kesfet: [
    {
      ...
      text: "Diğer yazarların paylaştığı eserleri burada okuyabilirsin. Belki bir hikaye seni ilham verir.",
      position: "bottom",
      alwaysVisible: true,
    },
    {
